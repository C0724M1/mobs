...
<div class="grid-container">
    <main>
        <div class="row justify-content-center">
            <!-- Lặp qua từng bookShop -->
            <c:forEach items="${bookShops}" var="bookShop">
                <div class="col-md-3 mb-3 ">
                    <!-- Card cho mỗi cuốn sách -->
                    <div class="card h-100">
                        <img src="${bookShop.imgURL}" class="card-img-top" alt="${bookShop.book_Name}" height="300px">
                        <div class="card-body d-flex flex-column">
                            <a style="text-decoration: none;" href="/bookdetail?id=${bookShop.book_ID}"
                               class="card-title">${bookShop.book_Name} </a>
                            <p class="card-text">${bookShop.price}</p>
                        </div>
                    </div>
                </div>
            </c:forEach>
